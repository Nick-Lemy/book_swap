...
class OtherUserProfilePage extends StatelessWidget {
  ...
  const OtherUserProfilePage({super.key, this.userProfile});

  @override
  Widget build(BuildContext context) {
    // Use provided profile or dummy data
    final profile =
        userProfile ??
        UserProfile(
          id: '1',
    ...
    // Get user's books (in real app, filter by user ID)
    final userBooks = dummyBooks.take(3).toList();
